<fieldset>
    ...
    <input type="number" id="precio" name="propiedad[precio]" placeholder="Precio Propiedad" value="<?php echo sanitizarHTML($propiedad->precio); ?>">
    ...
    <select name="propiedad[vendedores_id]" id="vendedor">
        ...
        <?php foreach ($vendedores as $vendedor) : ?>
            <option
                ...
                <?php echo sanitizarHTML($vendedor->nombre) . " " . sanitizarHTML($vendedor->apeliido); ?>
            </option>
        <?php endforeach; ?>
